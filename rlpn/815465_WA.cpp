...
int main() {
	...
	if((a4<b2 || b4<a2) || (a3<b1 || b3<a1)) {
		printf("none");
	} else if((a1==b1 && a2==b2)  || (b3==a1 && b4==a2) || (b3==a1 && b2==a2) || (b1==a1 && b4==a2)) { //point
	 	printf("point");
	} else if((a3==b1 && a2==b2)  || (b3==a3 && b4==a2) || (b3==a3 && b2==a2) || (b1==a3 && b4==a2)) {
		printf("point");
	} else if((a1==b1 && a4==b2)  || (b3==a1 && b4==a4) || (b3==a1 && b2==a4) || (b1==a1 && b4==a4)) {
		printf("point");
	} else if((a3==b1 && a4==b2)  || (b3==a3 && b4==a4) || (b3==a3 && b2==a4) || (b1==a3 && b4==a4)) {
		printf("point");
